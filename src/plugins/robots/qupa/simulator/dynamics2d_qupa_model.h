...
#define DYNAMICS2D_QUPA_MODEL_H
...
namespace argos {
   ...
   class CDynamics2DQupaModel : public CDynamics2DMultiBodyObjectModel {

   public:

      CDynamics2DQupaModel(CDynamics2DEngine& c_engine,
                              CQupaEntity& c_entity);
      virtual ~CDynamics2DQupaModel();
