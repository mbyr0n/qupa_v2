/**
 * @file <argos3/plugins/robots/qupa/control_interface/ci_qupa_motor_ground_sensor.h>
 *
 * @brief This file provides the interface of the qupa motor ground sensor.
 *
...
#define CCI_QUPA_MOTOR_GROUND_SENSOR_H

namespace argos {
   class CCI_QupaMotorGroundSensor;
}
...
namespace argos {
   ...
   class CCI_QupaMotorGroundSensor : public CCI_Sensor {
   ...
   public:
      ...
      CCI_QupaMotorGroundSensor();

      virtual ~CCI_QupaMotorGroundSensor() {}
   ...
   std::ostream& operator<<(std::ostream& c_os, const CCI_QupaMotorGroundSensor::SReading& s_reading);
   std::ostream& operator<<(std::ostream& c_os, const CCI_QupaMotorGroundSensor::TReadings& t_readings);
