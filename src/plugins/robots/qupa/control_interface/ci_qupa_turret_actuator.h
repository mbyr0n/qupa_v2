/**
 * @file <argos3/plugins/robots/qupa/control_interface/ci_qupa_turret_actuator.h>
 *
...
#define CCI_QUPA_TURRET_ACTUATOR_H

namespace argos {
   class CCI_QupaTurretActuator;
}
...
namespace argos {
   ...
   class CCI_QupaTurretActuator : virtual public CCI_Actuator {
   ...
   public:
       ...
       * Destructor.
       */
      virtual ~CCI_QupaTurretActuator() {}
       ...
       * @param un_mode turret control mode, possible values are defined in CCI_QupaTurretActuator
       */
