/**
 * @file <argos3/plugins/robots/qupa/control_interface/ci_qupa_distance_scanner_sensor.h>
 *
...
#define CCI_QUPA_DISTANCE_SCANNER_SENSOR_H

/* To avoid dependency problems when including */
namespace argos {
   class CCI_QupaDistanceScannerSensor;
}
...
namespace argos {
   ...
   class CCI_QupaDistanceScannerSensor : public CCI_Sensor {
   ...
   public:
       ...
       * Destructor
       */
      virtual ~CCI_QupaDistanceScannerSensor() {}
