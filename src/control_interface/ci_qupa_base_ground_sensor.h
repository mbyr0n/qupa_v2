/**
 * @file <argos3/plugins/robots/qupa/control_interface/ci_qupa_base_ground_sensor.h>
 *
 * @brief This file provides the interface of the qupa base ground sensor.
 *
...
#ifndef CCI_QUPA_BASE_GROUND_SENSOR_H
#define CCI_QUPA_BASE_GROUND_SENSOR_H

namespace argos {
   class CCI_QupaBaseGroundSensor;
}
...
namespace argos {
   ...
   class CCI_QupaBaseGroundSensor : virtual public CCI_Sensor {
   ...
   public:
      ...
      CCI_QupaBaseGroundSensor();

      virtual ~CCI_QupaBaseGroundSensor() {}
