...
namespace argos {
  ...
  const CCI_QupaEncoderSensor::SReading& CCI_QupaEncoderSensor::GetReading() const {
    return m_sReading;
  }
...
#ifdef ARGOS_WITH_LUA
  void CCI_QupaEncoderSensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
  void CCI_QupaEncoderSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
