/**
 * @file <argos3/plugins/robots/qupa/simulator/qupa_turret_entity.h>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#ifndef QUPA_TURRET_ENTITY_H
#define QUPA_TURRET_ENTITY_H
...
namespace argos {
   ...
   class CQupaTurretEntity : public CEntity {
   ...
   public:
      ...
      CQupaTurretEntity(CComposableEntity* pc_parent);
