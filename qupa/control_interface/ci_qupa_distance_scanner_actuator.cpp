/**
 * @file <argos3/plugins/robots/qupa/control_interface/ci_qupa_distance_scanner_actuator.cpp>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#include "ci_qupa_distance_scanner_actuator.h"
...
namespace argos {
   ...
   int LuaDistanceScannerEnable(lua_State* pt_lua_state) {
      ...
      /* Perform action */
      CLuaUtility::GetDeviceInstance<CCI_QupaDistanceScannerActuator>(pt_lua_state, "distance_scanner")->Enable();
      return 0;
   }
   ...
   int LuaDistanceScannerDisable(lua_State* pt_lua_state) {
      ...
      /* Perform action */
      CLuaUtility::GetDeviceInstance<CCI_QupaDistanceScannerActuator>(pt_lua_state, "distance_scanner")->Disable();
      return 0;
   }
   ...
   int LuaDistanceScannerSetAngle(lua_State* pt_lua_state) {
      ...
      /* Perform action */
      CLuaUtility::GetDeviceInstance<CCI_QupaDistanceScannerActuator>(pt_lua_state, "distance_scanner")->SetAngle(CRadians(lua_tonumber(pt_lua_state, 1)));
      return 0;
   }
   ...
   int LuaDistanceScannerSetRPM(lua_State* pt_lua_state) {
      ...
      luaL_checktype(pt_lua_state, 1, LUA_TNUMBER);
      /* Perform action */
      CLuaUtility::GetDeviceInstance<CCI_QupaDistanceScannerActuator>(pt_lua_state, "distance_scanner")->SetRPM(lua_tonumber(pt_lua_state, 1));
      return 0;
   }
#endif
...
#ifdef ARGOS_WITH_LUA
   void CCI_QupaDistanceScannerActuator::CreateLuaState(lua_State* pt_lua_state) {
