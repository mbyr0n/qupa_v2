...
/**
 * @file <argos3/plugins/robots/qupa/control_interface/ci_qupa_motor_ground_sensor.cpp>
 *
 * @author Carlo Pinciroli <ilpincy@gmail.com>
 */

#include "ci_qupa_motor_ground_sensor.h"
...
namespace argos {
   ...
   CCI_QupaMotorGroundSensor::CCI_QupaMotorGroundSensor() :
      m_tReadings(4) {
   ...
   const CCI_QupaMotorGroundSensor::TReadings& CCI_QupaMotorGroundSensor::GetReadings() const {
     return m_tReadings;
   }
   ...
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_QupaMotorGroundSensor::SReading& s_reading) {
   ...
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_QupaMotorGroundSensor::TReadings& t_readings) {
      if(! t_readings.empty()) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_QupaMotorGroundSensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_QupaMotorGroundSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
