/**
 * @file <argos3/plugins/robots/qupa/control_interface/ci_qupa_distance_scanner_actuator.h>
 *
...
#define CCI_QUPA_DISTANCE_SCANNER_ACTUATOR_H

/* To avoid dependency problems when including */
namespace argos {
   class CCI_QupaDistanceScannerActuator;
};
...
namespace argos {
   ...
   class CCI_QupaDistanceScannerActuator: virtual public CCI_Actuator {
   ...
   public:
        ...
        * Destructor.
        */
      virtual ~CCI_QupaDistanceScannerActuator() {}
